-- TrainMaat MySQL schema voor de webapp (volledig, met alle uitbreidingen)
-- Uitvoeren op de server: mysql -u user -p database < create_gymies_tables.sql

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- ========== TABELLEN DROP (volgorde vanwege foreign keys) ==========
