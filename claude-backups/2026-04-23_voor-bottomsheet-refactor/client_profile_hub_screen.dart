    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text('Wat is je doel?', style: GoogleFonts.fjallaOne(fontSize: 18)),
          ),
          const Divider(),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text('Donkere modus', style: GoogleFonts.fjallaOne(fontSize: 18)),
          ),
          const Divider(),
          for (final opt in ['Systeem', 'Licht', 'Donker'])
            ListTile(
              title: Text(opt),
              trailing: _darkModeSetting == opt
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text('Stille uren', style: GoogleFonts.fjallaOne(fontSize: 18)),
          ),
          const Divider(),
          for (final opt in ['Uit', '22:00 - 08:00', '23:00 - 07:00'])
            ListTile(
              title: Text(opt),
              trailing: _silentHoursSetting == opt
                  ? const Icon(Icons.check, color: GymiesColors.primary)
                  : null,
              onTap: () {
