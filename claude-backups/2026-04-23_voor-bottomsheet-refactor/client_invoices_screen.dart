          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  number,
                  style: GoogleFonts.fjallaOne(fontSize: 22, color: GymiesColors.darkBlue),
                ),
                ...
                if (status.toLowerCase() == 'betaald') ...[
                  const SizedBox(height: 16),
                  Text('Betaalbewijs', style: GoogleFonts.fjallaOne(fontSize: 16, color: GymiesColors.darkBlue)),
                ...
                if (link.isNotEmpty) ...[
                  const SizedBox(height: 20),
                  Text('PDF downloaden', style: GoogleFonts.fjallaOne(fontSize: 16, color: GymiesColors.darkBlue)),
                  const SizedBox(height: 8),
                  Text(
                ...
                if (link.isEmpty) ...[
                  const SizedBox(height: 16),
                  Text('Geen downloadlink beschikbaar.', style: TextStyle(fontSize: 13, color: Colors.grey.shade600)),
                ],
              ],
            ),
          ),
  ...
  List<Widget> _buildInvoicesList(List<Map<String, dynamic>> filtered) {
    return [
      ...
      Padding(
        ...
        child: Row(
          children: [
            _FilterPill(label: 'Alles', selected: _statusFilter == 'all', onTap: () => setState(() => _statusFilter = 'all')),
            const SizedBox(width: 6),
            _FilterPill(label: 'Betaald', selected: _statusFilter == 'paid', onTap: () => setState(() => _statusFilter = 'paid')),
            const SizedBox(width: 6),
            _FilterPill(label: 'Openstaand', selected: _statusFilter == 'open', onTap: () => setState(() => _statusFilter = 'open')),
          ],
        ),
      ),
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.fjallaOne(fontSize: 14, color: GymiesColors.darkBlue),
                        ),
                        const SizedBox(height: 3),
                        Text('$date om $time', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      sentInvoice != null
                          ? FilledButton.icon(
                              onPressed: () => _showInvoiceDetail(sentInvoice),
                          ...
                          : requestBusy
                              ...
                              : TextButton(
                                  onPressed: () => _requestInvoiceForBooking(b),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(number, style: GoogleFonts.fjallaOne(fontSize: 14, color: GymiesColors.darkBlue)),
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          r['amount'].toString(),
                          style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: Colors.green.shade700),
                        ),
                        const SizedBox(height: 4),
                        Icon(Icons.chevron_right, color: Colors.grey.shade400, size: 18),
                      ],
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              value,
              style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: valueColor ?? GymiesColors.darkBlue),
            ),
          ),
        ],
      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            title,
            textAlign: TextAlign.center,
            style: GoogleFonts.fjallaOne(fontSize: 20, color: GymiesColors.darkBlue),
          ),
          const SizedBox(height: 6),
          Text(
            subtitle,
