...
class _ClientHomeScreenState extends State<ClientHomeScreen>
  ...
  void _openTrainerProfile(Booking booking) {
    if (booking.trainerUserId != null) {
      Navigator.of(context).push(
        MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    final firstName =
        (user?['name'] as String? ?? 'Sporter').split(' ').first;
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                GymiesColors.primary.withValues(alpha:0.85),
              ],
                  ...
                  children: [
                    ...
                    Text(
                      streak > 2
                          ...
                          : streak > 0
                              ? 'Mooie start! Blijf consistent.'
                              : 'Boek een sessie om te beginnen.',
                      style: GoogleFonts.sora(
                        fontSize: 13,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // Bekijk trainer (outline)
                  Expanded(
                    child: GestureDetector(
                      onTap: () => _openTrainerProfile(next),
                      child: Container(
                        padding: const EdgeInsets.symmetric(vertical: 10),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
