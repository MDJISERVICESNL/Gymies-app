...
class _LoginTabState extends State<_LoginTab> {
  ...
  Duration _lockDuration(int fails) {
    ...
    final seconds = (5 * (1 << (fails - 3))).clamp(5, 300);
        ...
        child: Column(
          ...
          children: [
            _GymiesFormField(
              ...
              validator: (v) =>
                  (v == null || v.trim().isEmpty) ? 'Vul je e-mail in' : null,
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            _GymiesCheckbox(
              ...
              onLinkTap: () => launchUrl(
                Uri.parse('https://www.gymies.nl/voorwaarden'),
            ...
            _GymiesCheckbox(
              ...
              onLinkTap: () => launchUrl(
                Uri.parse('https://www.gymies.nl/privacy'),
                mode: LaunchMode.externalApplication,
              ),
            ),
            const SizedBox(height: 8),
