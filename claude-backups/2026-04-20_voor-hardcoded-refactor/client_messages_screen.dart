                      ...
                      itemBuilder: (_, i) {
                        ...
                        return TweenAnimationBuilder<double>(
                          ...
                          onDismissed: (direction) {
                            // NOTE: deleteConversation() API method does not exist yet.
                            // Implement the API endpoint and uncomment the call below.
                            if (mounted) {
                              setState(() {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  ...
                                  action: SnackBarAction(
                                    ...
                                    onPressed: () {
                                      // Reload to restore conversation
                                      _load();
                                    },
                                  ),
                                ),
                            ...
                            // TODO: Once deleteConversation() is implemented in GymiesApi,
                            // uncomment this code:
                            // try {
                            //   await context.read<GymiesApi>().deleteConversation(id);
                            // } catch (e) {
                            //   if (mounted) {
                            //     ScaffoldMessenger.of(context).showSnackBar(
                            //       SnackBar(
