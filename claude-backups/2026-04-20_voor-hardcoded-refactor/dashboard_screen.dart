...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Booking? _checkInWindowSession() {
    ...
    final candidates = _bookings.where((b) {
      ...
      final startWindow = b.scheduledAt.subtract(const Duration(minutes: 15));
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate((_, i) {
                    ...
                    final animationDelay = Duration(
                      milliseconds: 400 + (i.clamp(0, 10) * 80),
                    );
...
class _NextSessionCard extends StatelessWidget {
  ...
  Future<void> _openMaps() async {
    ...
    final apple = Uri.parse('https://maps.apple.com/?q=$encoded');
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          hasActiveFilters
              ? 'Probeer filters aan te passen of zoek in een andere stad.'
