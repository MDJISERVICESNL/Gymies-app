...
class _LoadingScreenState extends State<LoadingScreen>
  ...
  void initState() {
    super.initState();
    // Keep loading backend work in background, but do not block app entry.
    BackendService();
  ...
  Future<void> _navigateToNext() async {
    ...
    // Wacht tot loadStoredAuth klaar is – voorkomt redirect naar login tijdens laden
    if (auth.loadingStored && mounted) {
