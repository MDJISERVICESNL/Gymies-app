...
class _ClientTrainerProfileScreenState
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          title: Row(
            children: [
              Icon(Icons.event_available_rounded, color: GymiesColors.primary),
              const SizedBox(width: 8),
              const Expanded(child: Text('Boeking bevestigen')),
            ],
          ),
          content: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('Totaal', style: TextStyle(fontSize: 15)),
                    Text(
                      priceLabel,
                      style: TextStyle(
                        fontSize: 22,
              ...
              RadioListTile<String>(
                ...
                title: const Text('Online betalen (iDEAL / kaart)'),
              ...
              RadioListTile<String>(
                ...
                groupValue: selectedPaymentMethod,
                onChanged: (v) => setDialogState(() => selectedPaymentMethod = v!),
                title: const Text('Cash betalen bij trainer'),
          ...
          actions: [
            ...
            FilledButton.icon(
              ...
              icon: Icon(selectedPaymentMethod == 'cash'
                  ? Icons.check_rounded
                  : Icons.lock_rounded,
              ),
              label: Text(selectedPaymentMethod == 'cash'
                  ? 'Bevestig boeking'
                  : 'Ga naar betaling',
              ),
            ),
    ...
    try {
      ...
      final holdToken =
          (_activeSlotHold?['token'] ??
              ...
              ?.toString();
      final bookingData = await context.read<GymiesApi>().createDirectBooking(
        trainerUserId: trainer.userId,
        scheduledAt: dt,
      ...
      if (paymentUrl.isEmpty) {
        _showError('Kon geen betaallink ophalen. Probeer het opnieuw via Mijn Sessies.');
        Navigator.of(context).pop(true);
        return;
      }
  ...
  Future<void> _autoSyncToCalendar(
    ...
    try {
      ...
      debugPrint('[CalendarAutoSync] Fout: $e');
