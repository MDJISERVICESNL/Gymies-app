    ...
    return Scaffold(
      ...
      body: GymiesListBody(
        ...
        child: ListView(
                  ...
                  children: [
                    // ── Custom Slug ──────────────────────────────────
                    const GymiesSectionHeader('Profiel URL'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                    ...
                    // ── Brand Kleur ──────────────────────────────────
                    const GymiesSectionHeader('Brand kleur'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                    ...
                    // ── Logo ─────────────────────────────────────────
                    const GymiesSectionHeader('Logo'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                    ...
                    // ── Banner ────────────────────────────────────────
                    const GymiesSectionHeader('Banner'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                    ...
                    // ── Intro Video ─────────────────────────────────
                    const GymiesSectionHeader('Intro video'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                    ...
                    // ── Geverifieerd Badge ───────────────────────────
                    const GymiesSectionHeader('Geverifieerd badge'),
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Row(
