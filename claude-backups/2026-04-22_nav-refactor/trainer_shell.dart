...
import '../trainer_business_hub_screen.dart';
...
///   4 Business   – TrainerBusinessHubScreen
///
...
class TrainerShellState extends State<TrainerShell> {
  ...
  Widget _buildTab(int index) {
    ...
    switch (index) {
      ...
      case 2:
        return TrainerInboxScreen(onAvatarTap: _openProfile);
      case 3:
      ...
      case 4:
        return TrainerBusinessHubScreen(onAvatarTap: _openProfile);
      default:
