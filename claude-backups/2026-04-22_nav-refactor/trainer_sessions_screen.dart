  ...
  Future<void> _load() async {
    ...
    try {
      ...
      try {
        ...
        debugPrint('[TrainerSessions] Invoices laden fout: $e');
        invoicesByBooking = {};
      }
      if (mounted) {
        setState(() {
      ...
      debugPrint('[TrainerSessions] Sessies laden fout: $e');
      if (mounted) {
        setState(() {
    ...
    try {
      ...
      if (notifyStandby) {
        try {
          ...
          debugPrint('[TrainerSessions] Waitlist notificatie fout: $e');
    ...
    if (existingInvoiceId.isNotEmpty) {
      ...
      if (existingPdfUrl.isEmpty) {
        try {
          ...
          debugPrint('[TrainerSessions] Invoice PDF link ophalen fout: $e');
    ...
    try {
      ...
      if (previewPdfUrl.isEmpty) {
        try {
          ...
          debugPrint('[TrainerSessions] Invoice list reload fout: $e');
