...
final class GymiesSubscriptionController extends Controller
{
    ...
    use SubscriptionPaymentTrait, SubscriptionWebhookTrait {
        SubscriptionPaymentTrait::getSubscriptionMollieApiKey insteadof SubscriptionWebhookTrait;
    }
    ...
    public function mySubscription(Request $request): JsonResponse
    {
        ...
        // Expliciete velden — voorkom data leaks (geen s.* → geen Mollie tokens, interne IDs, etc.)
        $select = [
            's.id',
            's.trainer_user_id',
            's.plan_id',
        ...
        // Optionele kolommen die mogelijk later zijn toegevoegd
