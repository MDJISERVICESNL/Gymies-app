...
class GymiesClientVideosController
{
    ...
    public function store(Request $request, string $clientUserId): JsonResponse
    {
        ...
        // Max 100MB videobestand
        if ($file->getSize() > 100 * 1024 * 1024) {
            return response()->json(['message' => 'Video mag maximaal 100MB zijn.'], 422);
        }

        // Magic-byte MIME check — voorkom executable uploads vermomd als video
        $detectedMime = null;
